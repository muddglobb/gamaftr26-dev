  ...
  return (
    <div className="hero-section relative overflow-hidden bg-linear-to-b from-glacier-400 to-white">
        ...
        <div className="hero-content relative h-200 flex flex-col justify-center items-center z-100">
            <div className="hero-header flex flex-col justify-center items-center mb-12">
                <Image src={heroHeader} className="object-contain w-190 h-40"/> 
                <H5>Revealing the Path, Lighting the Way Towards Brighter Futures</H5>
            </div>
            <div className="hero-countdown relative flex flex-row">
                <div className="countdown-opening-ceremony justify-center items-center mx-10">
                ...
                <div className="countdown-bedah-kampus justify-center items-center mx-10">
